...
| `semantic-corpora` (6) | **2/6 merged (#76, #83)** | Dual-source corpora for **~~patent-ip ✅~~ · post-market-safety · clinical-trial-registry · payer-market-access · manufacturing-cmc · ~~dea-scheduling ✅~~**, per the **locked** method. **patent-ip merged** (#76, 7 granted-patent cards). **dea-scheduling merged** (#83, squash `f93c2f6`): 9 verified cards, **all T1 `govinfo.gov`** (psilocybin/LSD/MDMA Sched I · ketamine/esketamine/GHB/dronabinol/marijuana-2026 Sched III · Epidiolex Sched V), `validate-corpus.sh` CLEAN, suite 571, anti-fabrication spot-verified (4/4 quotes verbatim). EMET Pass B for both pending the Claude-extension host-permission for `emet.benchsci.com` (the EMET-*central* corpora post-market-safety + clinical-trial-registry are gated on it). Remaining Pass-A-amenable: payer-market-access, manufacturing-cmc. | — | [tools](tools.md) · [**brief**](../docs/superpowers/plans/2026-06-23-semantic-corpora-delegation.md) |

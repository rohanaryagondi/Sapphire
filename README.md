...
| [`site/`](site/) | **Interactive localhost walkthrough** — methodology flow, the animated gate→boost system flow, the 3-layer data map, and the clickable 16-capability dashboard. Run `python -m http.server` in that folder. |

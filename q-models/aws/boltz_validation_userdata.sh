...
set -x
date
echo "===== ROHAN-BOLTZ-VALIDATION USERDATA START ====="
...
curl -fsS --retry 5 --retry-delay 5 -o /home/ubuntu/inputs/validation_panel.json "$PANEL_URL" || echo "PANEL_DL_FAILED"
...
python3 -c "import json; d=json.load(open('/home/ubuntu/inputs/validation_panel.json')); print(len(d), 'complexes')" || echo "PANEL_PARSE_FAILED"
...
python boltz_runner_multimer.py validation_panel.json 2>&1

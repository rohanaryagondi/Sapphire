...
set -x
date
echo "===== ROHAN-BOLTZ-ROUND2 USERDATA START ====="
...
curl -fsS --retry 5 --retry-delay 5 -o /home/ubuntu/inputs/round2_panel.json "$PANEL_URL" || echo "PANEL_DL_FAILED"
...
python3 -c "import json; d=json.load(open('/home/ubuntu/inputs/round2_panel.json')); print(len(d), 'complexes')" || echo "PANEL_PARSE_FAILED"
...
python boltz_runner_multimer.py round2_panel.json 2>&1

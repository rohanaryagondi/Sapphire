...
export function CommandPalette() {
  ...
  return (
    <Command.Dialog
      ...
      className="fixed left-1/2 top-[18vh] z-[100] w-[min(620px,92vw)] -translate-x-1/2 overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-panel)] shadow-[0_24px_64px_rgba(0,0,0,0.22)]"
      overlayClassName="fixed inset-0 z-[99] bg-black/25 backdrop-blur-sm fadein"
    >
